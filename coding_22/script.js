...
btnScrollTo.addEventListener(`click`, function (e) {
  ...
  console.log(`current croll(x/y)`, window.pageXOffset, window.pageYOffset);
...
document.getElementById(`ection--1`);
...
const alertH1 = function (e) {
  alert(`addEvenetListener: Great! You are rading the heading :D`);
};
...
/* h1.onmouseenter = function (e) {
  alert(`onmouseenter: Great! You are rading the heading :D`);
};
 */
